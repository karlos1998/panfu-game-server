...
- JDBC repositories for atomic ticket consumption, presence and idempotent minigame rewards;
...
- minigame scores are capped, time-checked and recorded once per server-generated round UUID;
